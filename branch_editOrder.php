...
mysql_select_db($database_shoethai, $shoethai);
$query_Recordset1 = "SELECT * FROM orderbranch ORDER BY dateOrderbranch ASC";
...
<form action="<?php echo $editFormAction; ?>" id="form1" name="form1" method="POST">
  <table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td bgcolor="#CCCCFF">&nbsp;</td>
      <td bgcolor="#CCCCFF">&nbsp;</td>
      <td bgcolor="#CCCCFF"><input name="lotNo" type="hidden" id="lotNo" value="<?php echo $row_Recordset1['lotNo']; ?>" /></td>
    </tr>
    <tr>
      <td bgcolor="#CCCCFF">&nbsp;</td>
      <td bgcolor="#CCCCFF">&nbsp;</td>
